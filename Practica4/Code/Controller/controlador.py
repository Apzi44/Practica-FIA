...
class Controlador:
    ...
    def _conectar_eventos(self):
        ...
        self.vista.boton_eleccion_subconjunto_por_atributo.configure(command= lambda: print("En desarrollo"))
    ...
    def _actualizar_tabla(self):
        ...
        self.vista.mostrar_datos_tabla(datos_cualitativos, datos_cuantitativos, self.modelo.nombre_atributos)
        
        datos= self.modelo.obtener_datos_valores()
        self.vista.crear_tabla(datos, self.modelo.nombre_atributos)
    ...
    def _subconjunto_por_atributos(self):
        if self.modelo.verificar_existencia():
            ...
            if atributos:
                ...
                if resultado:
                    self.modelo.subconjunto_atributos(atributos)
                    self._actualizar_tabla()
